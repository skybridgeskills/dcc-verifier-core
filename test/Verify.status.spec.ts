...
import { DID_WEB_UNRESOLVED, INVALID_CREDENTIAL_ID, INVALID_SIGNATURE, NO_PROOF, STATUS_LIST_NOT_FOUND, STATUS_LIST_EXPIRED, STATUS_LIST_SIGNATURE_ERROR } from '../src/constants/errors.js';
...
describe('status checks', () => {
    ...
    describe('returns log error', () => {
        ...
        it('when status list has expired', async () => {
        ...
        it('when status list has been tampered with', async () => {
